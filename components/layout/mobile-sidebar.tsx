        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          >
            ...
            <div className="border-t border-border p-3">
              <button className="flex w-full items-center gap-2.5 rounded-control px-2 py-2 text-left transition-colors duration-200 hover:bg-white/[0.04]">
                ...
                <div className="min-w-0 flex-1">
                  <div className="truncate text-[13px] font-medium text-text-primary">Are Khan</div>
                  <div className="truncate text-[11.5px] text-text-muted">Growth workspace</div>
                </div>
